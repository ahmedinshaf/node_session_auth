...
var objectId = function (joi) { return ({
    type: 'objectId',
    base: joi.string(),
    messages: {
...
var validate = function (schema, payload) { return __awaiter(void 0, void 0, void 0, function () {
    var e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, schema.validateAsync(payload, { abortEarly: false })];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
