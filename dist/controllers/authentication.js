...
var register = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, name, password, found, user, link;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, validation_1.validate(validation_1.registerSchema, req.body)];
            case 1:
                _b.sent();
                _a = req.body, email = _a.email, name = _a.name, password = _a.password;
                return [4 /*yield*/, user_1.User.exists({ email: email })];
            case 2:
                found = _b.sent();
                if (found) {
...
var login = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, validation_1.validate(validation_1.loginSchema, req.body)];
            case 1:
                _c.sent();
