...
exports.asyncWrap = exports.serverError = exports.notFound = exports.catchAsync = void 0;
...
var notFound = function (req, res, next) { return res.status(404).json({ message: 'Route Not Found' }); };
